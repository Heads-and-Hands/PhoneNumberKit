...
public final class PartialFormatter {
    ...
    public func formatPartial(_ rawNumber: String) -> String {
        ...
        guard self.isValidRawNumber(rawNumber) else {
            let partialFormatted = rawNumber.filter { PhoneNumberConstants.validCharacters.contains($0) }
        ...
        let split = splitNumberAndPausesOrWaits(String(rawNumber.prefix(rawNumber.count > 13 ? rawNumber.count - 13 : rawNumber.count)))
